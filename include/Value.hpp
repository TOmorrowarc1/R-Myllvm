...
public:
  BinaryOperator(const std::string& name, Type* type, Value* lhs, Value* rhs, const std::string& op);
...
public:
  UnaryOperator(const std::string& name, const std::string& op, Type* type, Value* operand);
...
public:
  ICmpInst(const std::string& name, const std::string& predicate, Type* type, Value* lhs, Value* rhs);
...
public:
  CallInst(const std::string& name, Function* function, const std::vector<Value*>& args);
...
public:
  GetElementPtrInst(const std::string& name, Type* type, Type* base_type, Value* ptr, const std::vector<Value*>& indices);
